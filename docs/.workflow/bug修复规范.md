...
| 子Agent | 阶段 | 主要输出 | 依赖前置文档 |
|---------|------|----------|-------------|
| Bug根因分析 | 分析中 | `03-根因分析.md`、`事实锚点.json` | `01-问题描述.md`、`02-环境与影响范围.md` |
| Bug独立复核 | 分析中 / 修复方案 / 修复中 / 验证 | 闭环复核摘要或 `10-AI协作记录.md` | 复核对象阶段的全部文档 |
| Bug修复实现 | 修复中 | 代码/规范改动、`06-执行记录.md` | `03-根因分析.md`、`04-解决方案.md`、`05-任务拆解.md`、`事实锚点.json` |
| Bug回归验证 | 验证 / 验收发布 | `07-测试验证.md` | `05-任务拆解.md`、`06-执行记录.md` |
